                ...
                <div className="flex flex-col md:flex-row gap-16 md:gap-20 items-start">
                    <div className="hidden md:block w-64 shrink-0 sticky top-24">
                        ...
                        <div className="flex flex-col gap-2">
                            {SECTIONS.map(s => <a key={s.title} href={`#${s.id}`} className="text-[0.8125rem] text-slate-500 hover:text-brand-600 transition-colors">{s.title}</a>)}
                        </div>
                    ...
                    <div className="flex-1 flex flex-col gap-10">
                        {SECTIONS.map(s => (
                            <div key={s.title} id={s.id} className="pb-10 border-b border-slate-200 last:border-0 border-dashed text-pretty scroll-mt-24">
